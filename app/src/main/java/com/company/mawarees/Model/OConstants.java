...
public class OConstants {
        ...
        for (Person person : data) {
            ...
            if (!isRemainPerson(data, person) && !isPartnerPerson(data, person) && !isBlocked(person)) {
                if (X.getNumerator() != person.getSharePercent().getNumerator() && X.getDenominator() != person.getDeadSonNumber()) {
                    Log.i(TAG, "X != person SharePercent with value = " + X.getNumerator() + "/" + X.getDenominator());
    ...
    private static void calculatePersonShareValue(Person person, OConstants oConstants, boolean isHasRemainPeople, Fraction X) {
        ...
        try {
            ...
            if (isHasRemainPeople) {
                ...
                Log.i(TAG, "calculatePersonShareValue(): is Has Remain People And Money =  = " + money + " & remain = " + remain);
            ...
            double shareValue = (int) ((money * sharePercent));
    ...
    private static void setMoreThanBrotherAndSister(ArrayList<Person> data, Person person, Fraction sharePercents, double totalMoney, Fraction X) {
    ...
    private static boolean isPartnerPerson(ArrayList<Person> data, Person person) {
        try {
            ...
            if ((person.getRelation().matches(OConstants.PERSON_DAUGHTER) || person.getRelation().matches(OConstants.PERSON_SON)) &&
                    (moreThanThreeDaughters != null && moreThanThreeDaughters.getSharePercent() != null &&
                            (moreThanThreeDaughters.getSharePercent().getNumerator() == two_Thirds.getNumerator()
                                    && moreThanThreeDaughters.getSharePercent().getDenominator() == two_Thirds.getDenominator()))) {
                ...
                return true;
                    ...
                    (fatherUnclesAndAunts != null && fatherUnclesAndAunts.getSharePercent() != null &&
                            (fatherUnclesAndAunts.getSharePercent().getNumerator() == two_Thirds.getNumerator()
                                    && fatherUnclesAndAunts.getSharePercent().getDenominator() == two_Thirds.getDenominator()))) {
                ...
                return true;
                    ...
                    (motherUnclesAndAunts != null && motherUnclesAndAunts.getSharePercent() != null
                            && (motherUnclesAndAunts.getSharePercent().getNumerator() == one_Third.getNumerator()
                            && motherUnclesAndAunts.getSharePercent().getDenominator() == one_Third.getDenominator()))) {
                ...
                return true;
                    ...
                    (moreThanBrotherAndSister != null && moreThanBrotherAndSister.getSharePercent() != null &&
                            (moreThanBrotherAndSister.getSharePercent().getNumerator() == one_Third.getNumerator()
                                    && moreThanBrotherAndSister.getSharePercent().getDenominator() == one_Third.getDenominator()))) {
                ...
                return true;
                    ...
                    (moreThanThreeBrotherAndSister != null && moreThanThreeBrotherAndSister.getSharePercent() != null &&
                            (moreThanThreeBrotherAndSister.getSharePercent().getNumerator() == one.getNumerator()
                                    && moreThanThreeBrotherAndSister.getSharePercent().getDenominator() == one.getDenominator()))) {
            ...
            try {
                ...
                if (!isBlocked(person)) {
                    ...
                    if ((person.getRelation().matches(OConstants.PERSON_DAUGHTER) || person.getRelation().matches(OConstants.PERSON_SON)) &&
                        ...
                        setMoreThanBrotherAndSister(data, person, one_Third, oConstants.getTotalMoney(), X);
