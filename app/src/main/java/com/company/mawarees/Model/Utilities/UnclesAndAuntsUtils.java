...
public class UnclesAndAuntsUtils {
    ...
    private static void handleFatherUnclesAndAunts(ArrayList<Person> data, Fraction allShare, Fraction eachGroupShare) {
        ...
        try {
            ...
            int motherUnclesAndAuntsCount = OConstants.getPersonCount(data, OConstants.PERSON_MOTHER_AUNT) + (OConstants.getPersonCount(data, OConstants.PERSON_MOTHER_UNCLE) * 2);
